      ...
      items: [
        {
          ...
          github: 'https://github.com/LuthfiTaufiqulhakim',
          demo: 'https://luthfi-taufiqulhakim.github.io'
        },
    ...
    <article data-page="about">
      <header>
        <div
          ...
          <h4 class="text-[#81A263]">Past Project Experience</h4>
          <h4 class="text-base font-normal text-transparent bg-clip-text bg-gradient-to-r from-slate-600 to-[#365E32]">
        ...
        <div>
          <div class="grid grid-cols-1 gap-4 pb-32 md:grid-cols-3 md:gap-3 xl:grid-cols-3 xl:gap-3 2xl:gap-5 fade-zoom-in">
            <div v-for="item in items" :key="item.id">
              <div
                class="item-card flex flex-col items-center gap-2 rounded bg-[#81A263] hover:bg-[#365E32] border border-[#383838] rounded-xl text-amber-50 md:gap-3 px-5 py-5 lg:px-5 ">
