    ...
    <article data-page="about">
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-2/4 h-2/6 rounded-full mb-3 fadein-up"
            src="../assets/profileku.jpg" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi Viewers..! I have one year of experience as a Web Developer and have earned an expertise title in Front-End Development recognized by Dicoding Academy Indonesia.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; My goal is to continuously improve my skills in one programming language, which is Javascript, as well as learn Tech Frameworks that you can see below. 
          </p>
        </div>
